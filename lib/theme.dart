...
TextStyle genderTextStyle = const TextStyle(color: Colors.indigo, fontSize: 36.0, fontWeight: FontWeight.w600);
TextStyle matchTextStyle = const TextStyle(color: Colors.black, fontSize: 13);
